...
/**
The `yui.view` extension exposes an express view class that relies on all templates
...
module.exports = {
    ...
    Expose a View class for express.
        ...
        app.set('view', yui.view({ defaultBundle: 'app-name' });
        ...
        utils.extend(View.prototype, {
            ...
            lookup: function (templateName, options) {
                var bundleName = (options && options.bundle) || config.defaultBundle,
                    Y = bundleName && self.getYInstance();
