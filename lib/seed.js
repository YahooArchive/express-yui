...
module.exports = {
    ...
    **/
    ...
    Modules as `photos@hermes` denotated a module from a particular group,
    ...
    **/
    ...
    Modules as `cssflickr@hermes` denotated a module from a particular group,
    as in `<module-name>@<group-name>`. Modules without the group denotation
    will be assumed as core modules from yui.
