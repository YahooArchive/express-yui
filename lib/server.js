    ...
    registerBundle: function (bundle) {
        ...
        if (bundle.yui) {
            if (bundle.yui.client && bundle.yui.metaModuleName) {
                ...
                modules = utils.clone(bundle.yui.client);
                for (key in modules) {
                    if (modules.hasOwnProperty(key)) {
                        if (this._clientModules.hasOwnProperty(key) && this._clientModules[key] !== modules[key]) {
                            debug("Module name collision: the same name has been used already:" + key);
                        }
                    }
                }
            ...
            if (bundle.yui.server) {
                ...
                for (key in modules) {
                    if (modules.hasOwnProperty(key)) {
                        if (this._serverModules.hasOwnProperty(key) && this._serverModules[key] !== modules[key]) {
                            debug("Module name collision: the same name has been used already:" + key);
                        }
                    }
                }
