...
var debug = require('debug')('express:yui:loader-patch');

module.exports = {

    /**
    Adds a list of clientside patches that will be applied to the YUI instance
    before the initial `use` statement. Returns a list of patches when no
    arguments are passed.

    @method patchClient
    @public
    @param {Array} patches Optional list of patches. Returns existing list of
        patches if no arguments are passed.
    **/
    patchClient: function (patches) {
        ...
        if (config.patches && config.patches.length) {
            debug('Potentially overwriting default clientside patches');
        }
    ...
    **/
    patchServer: function (patches) {
        ...
        if (this._patches && this._patches.length) {
            debug('Potentially overwriting default serverside patches');
        }
