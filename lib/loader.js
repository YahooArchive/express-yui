...
module.exports = {
    ...
    **/
    ...
    configuration of the plugin.
        ...
        @param {RegExp|Function} options.filter optional regular express or function to execute
            ...
            bundleUpdated: function (evt, api) {
                ...
                return api.promise(function (fulfilled, rejected) {
                    ...
                    return api.writeFileInBundle(bundleName, destination_path, client.data.js).then(function (newfile) {
                        ...
                        // if cssproc is enabled, then we need to provision the proper shifter
                        // configuration for images in the css modules to be processed based on
                        // the group configuration, in this case `base` is going to be added
                        // in front of each `url()` in the css modules.
                        if (options.cssproc) {
                            config = yui.config();
