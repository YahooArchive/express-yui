                        ...
                        if (meta.hasOwnProperty(mod)) {
                            for (build in meta[mod].builds) {
                                if (meta[mod].builds.hasOwnProperty(build)) {
                                    if (meta[mod].builds[build].config.affinity !== 'client') {
                                    ...
                                    if (meta[mod].builds[build].config.affinity !== 'server') {
                    ...
                    return api.writeFileInBundle(bundleName, destination_path, client.data.js).then(function (newfile) {
                        ...
                        if (options.register) {
                            ...
                            if (options.attach) {
                                ...
                                // attaching server affinity modules on the server
                                yui.attachModules(bundleName, server.data.json);
                            }
                        }
