...
@static
@constructor
@uses *express, *express-expose, utils, cdn, seed, origin, groups, shifter, loader, server
*/
...
utils.extend(ExpressYUIExtension.prototype, cdn, seed, origin, groups, shifter, loader, server);
