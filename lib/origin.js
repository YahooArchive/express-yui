...
applications.
    ...
    app.use(app.yui.registerGroup('app', '/path/to/foo/yui-build'));
...
module.exports = {
    ...
    Here is an example on how to use it:
        ...
        app.use(app.yui.serveCoreFromOrigin({}, {}));
    ...
    @param {Object} options express static handler options
        ...
        @param {String} options.prefix optional prefix used to
            ...
            E.g.: `app.use('/static', app.yui.serveCoreFromAppOrigin({},
    ...
    **/
    ...
    @param {Object} options express static handler options
        ...
        under a particular path, you have to provide the prefix
        so loader can know about this mounted path.
        E.g.: `app.use('/static', app.yui.serveGroupFromAppOrigin('app',
        {}, {prefix: '/static/'}));`. Default is always `'/'`.
    ...
    **/
    ...
    @param {Object} options static combo handler options
        ...
        @param {Number} options.maxURLLength default to `1024`
        @param {String} options.comboBase default to `"/combo~"`
        @param {String} options.comboSep default to `"~"`
