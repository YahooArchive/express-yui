...
module.exports = {
    ...
    @chainable
    **/
    serveCoreFromAppOrigin: function (loaderConfig) {
    ...
    @chainable
    **/
    serveGroupFromAppOrigin: function (groupName, loaderConfig) {
    ...
    **/
    ...
    of `loaderConfig.comboBase` and `loaderConfig.comboSep` will be
    ...
    @chainable
    **/
    serveCombinedFromAppOrigin: function (loaderConfig) {
