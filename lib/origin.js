...
function getGroupConfig(metaFile) {
    // TODO: this should comes from a different place
    return {
        groupName: 'app',
        moduleName: 'metas',
        modules: {
...
module.exports = {
    ...
    **/
    ...
    @param {Function} fullpathResolver method used to map public paths
    with filesystem paths. Each module, including the meta module will
    be processed by this resolved to cache the filesystem path for each.
    @param {Object} options express static handler options
    ...
    **/
    serveGroupFromAppOrigin: function (metaPath, loaderConfig, fullpathResolver, options) {
        ...
        fullpath = fullpathResolver(metaPath);
        if (!fullpath) {
        ...
        this._addGroupToMap(groupName, group.modules, fullpathResolver);
        ...
        this._addGroupToMap(groupName, group.meta, fullpathResolver);
