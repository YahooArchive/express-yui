...
module.exports = {
    ...
    **/
    setCoreFromAppOrigin: function (loaderConfig) {
        ...
        var groupDefaultBase = this._app.set('yui default base') || "/{{groupDir}}/",
            ...
            comboConfig = this._app.set('yui combo config') || DEFAULT_COMBO_CONFIG,
            config = this.config(),
    ...
    @param {Object} loaderConfig optional custom loader configuration
    for the group.
    ...
    @chainable
    @deprecated in favor of setGroupConfig()
    **/
    setGroupFromAppOrigin: function (groupName, loaderConfig) {
        console.warn('`setGroupFromAppOrigin` method is deprecated, use `setGroupConfig` instead');
        return this.setGroupConfig(groupName, loaderConfig);
    },
    ...
    @chainable
    **/
    setGroupConfig: function (groupName, loaderConfig) {
    ...
    **/
    registerGroup: function (groupName, groupRoot, metaFile) {
        ...
        groupConfig = config.groups[groupName] = utils.extend({
            base: groupDefaultBase,
            root: groupDefaultRoot,
            local: !/^(http\:|https\:|\/\/)/.test(groupDefaultBase)
    ...
    **/
    combineGroups: function (loaderConfig) {
        ...
        loaderConfig = utils.extend({}, comboConfig, (loaderConfig || {}));
